...
def process_json_file():
    # Read the JSON file
    with open("/Users/andrewlanpouthakoun/Library/Mobile Documents/com~apple~CloudDocs/Stanford/Quizzem/ChatBot/book_index_retrieval/generated_content.json", 'r') as file:
        data = json.load(file)
